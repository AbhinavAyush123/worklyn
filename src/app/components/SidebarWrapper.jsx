...
export default function SidebarWrapper({ children }) {
 ...
 // Add state to track if AI results are showing (for blur effect)
 const isAiResultsVisible = aiResults !== null || isAiLoading || aiError !== null
 ...
 const handleAISearch = async () => {
   ...
   try {
     ...
     setAiError('Failed to get suggestions from AI.')
   } finally {
 ...
 // AI Job Card Skeleton Component
 ...
 const renderAIResults = () => {
   ...
   return (
     ...
     >
       {/* Backdrop blur overlay - only covers the AI results box area */}
       <div
           ...
           <div className="h-16 w-full border-b bg-white dark:bg-background border-blue-200 dark:border-blue-800 justify-between flex items-center px-4 relative">
             <div className="flex items-center gap-2 w-full relative">
               ...
               {isJobsPage && (
                 <div className="flex justify-center w-full relative">
                   ...
                   >
                     {/* Enhanced glow effect for AI mode */}
                     <div
                       className={clsx(
             ...
             <div className="flex gap-4 relative z-40">
               ...
               <Button
                 variant="default"
                 size="icon"
                 className="bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 group"
               >
                 <BellIcon className="group-hover:rotate-20 transition duration-200 text-white" />
               </Button>
             </div>
           </div>
