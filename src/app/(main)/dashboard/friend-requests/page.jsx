  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <Tabs
        ...
        className="mb-8"
      >
        <TabsList className="overflow-x-auto flex w-1/2 gap-2 sm:gap-4 md:gap-6 bg-white border-gray-200 rounded-lg p-1">
          <TabsTrigger
            value="overview"
            className="flex items-center space-x-2 px-4 py-2 text-sm font-medium data-[state=active]:text-white data-[state=active]:bg-blue-500 data-[state=active]:shadow border"
          >
          ...
          <TabsTrigger
            value="analytics"
            className="px-4 py-2 text-sm text-gray-600 font-medium data-[state=active]:bg-blue-500 data-[state=active]:shadow border data-[state=active]:text-white"
          >
            Analytics
          </TabsTrigger>
          <TabsTrigger
          ...
          <TabsTrigger
            value="notifications"
            className="px-4 py-2 text-sm text-gray-600 font-medium data-[state=active]:bg-blue-500 data-[state=active]:shadow-lg border data-[state=active]:text-white"
          >
            Notifications
          </TabsTrigger>
        </TabsList>
    ...
    <>
      ...
      <CardContent className="p-0 flex flex-col justify-between flex-grow">
        <div>
          ...
          <div className="text-[11px] text-gray-500 mt-0.5">Active Accounts</div>
        </div>
          ...
          students.map((user) => {
            ...
            return (
              <div key={user.id} className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <Badge variant="outline" className="text-xs text-white bg-purple-500 border-none">Student</Badge>
        ...
        recruiters.map((user) => {
          ...
          return (
            <div key={user.id} className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <Badge variant="outline" className="text-xs bg-purple-400 text-white border-none">Recruiter</Badge>
