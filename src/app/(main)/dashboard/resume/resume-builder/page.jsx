...
const handleDownloadPDF = async () => {
 try {
   ...
   sectionOrder.forEach(section => {
     ...
     yPos += lineHeight * 1.5; // Increased spacing after header
     ...
     if (yPos > 10.5) { // Letter height is 11 inches
       doc.addPage();
       yPos = margin;
     }
   });
  ...
  <div className="md:px-7 mt-7 max-w-8xl w-full">
   <Breadcrumb>
    ...
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
      ...
      <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-500 via-fuchsia-600 to-pink-500">
        {resumeId ? 'Edit Resume' : 'Resume Builder'}
      </h1>
      <div className="flex gap-3">
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button variant="default" className="flex gap-2 bg-green-600 hover:bg-green-700  items-center">
              <Save size={18} />
    ...
    <Tabs defaultValue="form" className="w-full mt-10">
      ...
      <TabsContent value="form" className="w-full mt-8">
        ...
        <h2 className="font-bold  bg-clip-text text-transparent bg-gradient-to-r from-violet-500 via-fuchsia-600 to-pink-500 flex items-center gap-2 text-xl mb-4 dark:text-white">
       ...
       <Card className="border-gray-200 p-6 shadow-none space-y-6 dark:border-none bg-neutral-50 dark:bg-neutral-900">
        ...
        {/* Summary Section */}
        <div className="mt-12">
          <span className="font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-500 via-fuchsia-600 to-pink-500 text-xl ">
        ...
        {/* Education Section */}
        <div className="mt-6">
          <h2 className="font-bold text-purple-500 text-xl flex gap-2 items-center dark:text-white">
            <GraduationCap size={15} />
            <span className='bg-clip-text text-transparent bg-gradient-to-r from-violet-500 via-fuchsia-600 to-pink-500'>Education</span>
          </h2>
        ...
        {/* Skills Section */}
        <div className="mt-6">
          <span className="font-bold text-sky-500 text-xl bg-clip-text text-transparent bg-gradient-to-r from-violet-500 via-fuchsia-600 to-pink-500">Skills</span>
        ...
        <div className="mt-6">
          <span className="font-bold text-sky-500 text-xl bg-clip-text text-transparent bg-gradient-to-r from-violet-500 via-fuchsia-600 to-pink-500">Work Experience</span>
        ...
        <div className="mt-6">
          <h2 className="font-bold text-purple-500 text-xl mb-4 flex items-center gap-2 dark:text-white">
            <Award size={24} />
            <span className='bg-clip-text text-transparent bg-gradient-to-r from-violet-500 via-fuchsia-600 to-pink-500'>
