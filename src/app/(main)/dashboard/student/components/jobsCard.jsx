         ...
         <AnimatePresence initial={false}>
           {jobs.map((job) => (
             <motion.div
               ...
               className={`group flex items-center gap-4 p-3 relative overflow-hidden rounded-2xl transition-all duration-300 mb-3 ${
                 job.isExpired
             ...
             >
               {/* Vertical urgency strip on the left */}
               <div
               ...
               <div className="flex items-center justify-between w-full gap-4 pl-3">
                 {/* LEFT SIDE: Logo or fallback */}
                 <div className="flex items-center gap-3 min-w-0">
                   <div className="flex-shrink-0 relative">
                     {job.image_url ? (
                       <img
                         ...
                         className="w-10 h-10 rounded-lg object-cover shadow-sm border border-blue-200 dark:border-gray-700"
                       />
                     ) : (
                       <div
                   ...
                   <div className="min-w-0">
                     ...
                     <div
                       className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${getUrgencyStyle(
                         job.daysLeft,
                         job.isExpired
                       )}`}
                     >
                       {job.isExpired ? (
                         ...
                         <>
                           ...
                           <span>
                             Due {job.daysLeft === 0 ? "today" : "tomorrow"}
                           </span>
                         </>
                       ) : (
                         <>
                 ...
                 <DropdownMenu>
                   ...
                   >
                     ...
                     >
                       ...
                       {unsavingIds.has(job.savedJobId)
                         ? "Removing..."
                         : "Unsave"}
                     </DropdownMenuItem>
                   </DropdownMenuContent>
